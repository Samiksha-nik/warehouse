...
import { FaClipboardCheck, FaCheck, FaTimes, FaSave } from 'react-icons/fa';
...
const OrderApproval = () => {
  ...
  const handleReject = async (orderId) => {
    if (window.confirm('Are you sure you want to reject this order?')) {
      try {
        setLoading(true);
        await axios.put(`http://localhost:5000/api/orders/${orderId}/reject`);
        fetchPendingOrders();
        setError(null);
      } catch (err) {
        ...
        <table className={styles.table}>
          ...
          <tbody>
            {loading ? (
              ...
              <tr>
                <td colSpan="5" className="text-center">No pending orders found</td>
              </tr>
            ) : (
